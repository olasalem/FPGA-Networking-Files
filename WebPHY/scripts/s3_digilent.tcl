# 
# Project automation script for s3_digilent 
# 
# Created for ISE version 14.4
# 
# This file contains several Tcl procedures (procs) that you can use to automate
# your project by running from xtclsh or the Project Navigator Tcl console.
# If you load this file (using the Tcl command: source s3_digilent.tcl), then you can
...
set myProject "s3_digilent"
set myScript "s3_digilent.tcl"
...
proc add_source_files {} {
   ...
   xfile add "../src/WebPHY_DATABUS.ngc"
   xfile add "../src/s3_digilent.ucf"
   xfile add "../src/s3_digilent.vhd"
   xfile add "../src/hex_to_quad7seg.vhd"
   xfile add "../src/mem.vhd"
   xfile add "../src/mydcm.vhd"
   xfile add "../src/servo.vhd"
   xfile add "../src/user_logic.vhd"
   xfile add "../src/webram.vhd"

   # Set the Top Module as well...
   project set top "s3_digilent_arch" "s3_digilent"
...
proc set_process_props {} {
   ...
   project set "Work Directory" "C:/Modeltech_pe_edu_10.1a/randy_modelsim_work/ethernet_udp_blaster/syn/xst" -process "Synthesize - XST"
   ...
   project set "Output File Name" "fpga_top" -process "Generate IBIS Model"
